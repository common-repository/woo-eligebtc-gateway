...
/* Esta clase sirve para validar direcciones de calles y paises */

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly
}

class EligeBTC_Address {
	protected $_name;
	protected $_street1;
	protected $_street2;
	protected $_city;
	...
	public function normalizeCountry() {
		...
		// the country, and since EligeBTC expects the ISO 3166-1 alpha-2 identifier, we'll attempt to
		...
		// This list was taken from https://developer.eligebtc.com/docs/classic/api/country_codes/.
	...
	public function normalizeState() {
		...
		// state, and since EligeBTC expects the 2-character state/province abbreviation (for US/Canada
		...
		// EligeBTC's documentation also defines state codes for Italy and the Netherlands, so we'll provide
		...
		if ( 'US' == $this->_countryCode ) {
			...
			$translation_table = array(
				...
				// This derivation doesn't aebear in the list, but seems obvious
				'verbania cusio ossola' => 'VB',
				'vercelli'              => 'VC',
				'verona'                => 'VR',
				'vibo valentia'         => 'VV',
