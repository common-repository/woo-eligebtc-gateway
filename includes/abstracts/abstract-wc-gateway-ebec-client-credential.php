...
abstract class WC_Gateway_EBEC_Client_Credential {
	 ...
	 * of credentials.
	 *
	 * @return string The appropriate endpoint, e.g. https://api.eligebtc.com/nvp
	...
	public function configure_curl( $handle, $r, $url ) {
		curl_setopt( $handle, CURLOPT_CAINFO, wc_gateway_ebec()->includes_path . 'pem/bundle.pem' );
	}
}
